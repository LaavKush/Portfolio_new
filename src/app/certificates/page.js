...
const CertificatesSection = () => {
  return (
    <section className="bg-black text-white py-24 px-4 md:px-10">
      <h2 className="text-4xl font-extrabold text-center mb-6 text-teal-300 tracking-wide">
        Certifications
      </h2>
        ...
        <div className="grid gap-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center">
          {certificates.map((cert, idx) => (
            <a
              ...
              className="w-full max-w-[360px] bg-[#111827] border border-gray-800 rounded-2xl p-8 shadow-xl
                         transition-all duration-300 hover:scale-105 hover:border-teal-400 hover:shadow-teal-500/20"
            >
              ...
              <p className="text-sm text-teal-400 text-center mt-6 font-medium">
                View Certificate →
              </p>
            </a>
          ))}
